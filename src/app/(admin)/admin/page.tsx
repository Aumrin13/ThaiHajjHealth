          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full text-left p-3 bg-green-50 dark:bg-green-900/20 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/30 transition-colors">
                ...
                <div className="text-sm text-green-600 dark:text-green-300">จัดการข้อมูลโรงพยาบาลและ รพ.สต.</div>
              </button>
            ...
            <div className="space-y-4">
              <div className="border-l-4 border-blue-500 pl-3">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  เจ้าหน้าที่จาก รพ.สต.บ้านนา - 5 นาทีที่แล้ว
                </p>
              </div>
              ...
              <div className="border-l-4 border-yellow-500 pl-3">
                ...
                <p className="text-xs text-gray-600 dark:text-gray-400">
                  ข้อมูลผู้ป่วยถูกอัพเดท - 2 ชั่วโมงที่แล้ว
                </p>
              </div>
            </div>
          </div>
